              ...
              <div className="pt-6">
                ...
                {hasStrategyAccess && (
                  <div className="space-y-2">
                    ...
                    <button className="w-full flex items-center justify-center px-4 py-3 mt-3 border-2 border-dashed border-gray-300 hover:border-blue-400 rounded-xl text-sm font-medium text-gray-600 hover:text-blue-700 transition-all duration-200 hover:bg-blue-50/50">
